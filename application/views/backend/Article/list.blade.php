                ...
                <tbody>
                  @foreach($post_list as $post)
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-danger btn-sm" href="{{ site_url('backend/article/hapus/' . $post->id ) }}" role="button">
                          <i class="bi bi-trash"></i>
                        </a>
                        <a class="btn btn-success btn-sm" href="{{ site_url('backend/article/ubah/' . $post->id ) }}">
